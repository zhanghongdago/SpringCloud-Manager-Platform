...
angular.module('activitiModeler')
    .controller('StencilController', ['$rootScope', '$scope', '$http', '$modal', '$timeout','$cookies', function ($rootScope, $scope, $http, $modal, $timeout, $cookies) {
        ...
        $scope.editorFactory.promise.then(function () {
            ...
            /*
             StencilSet items
             */
            $http({method: 'GET', url: KISBPM.URL.getStencilSet(),headers:{
                    'Authorization':KISBPM.COOKIE.get('Authorization'),
                    'X-Tenant-Auth':KISBPM.COOKIE.get('TenantKey')
