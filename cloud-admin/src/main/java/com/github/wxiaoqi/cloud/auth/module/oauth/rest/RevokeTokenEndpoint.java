...
public class RevokeTokenEndpoint {
    ...
    public ObjectRestResponse revokeToken(String access_token) throws Exception {
        if (access_token != null && access_token.startsWith(RequestHeaderConstants.JWT_TOKEN_TYPE)) {
            access_token = access_token.substring(RequestHeaderConstants.JWT_TOKEN_TYPE.length(), access_token.length());
        }
